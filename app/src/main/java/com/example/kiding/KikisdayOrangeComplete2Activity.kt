...
class KikisdayOrangeComplete2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdayOrangeComplete2Binding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdayOrangeComplete2Binding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            ...
            val previousActivity = when (number) {
                ...
                else -> Kikisday14Activity::class.java
            }
