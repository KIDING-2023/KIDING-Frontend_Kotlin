...
import com.example.kiding.databinding.ActivityKikisdayYellowCompleteBinding

class KikisdayYellowCompleteActivity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdayYellowCompleteBinding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdayYellowCompleteBinding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            ...
            val previousActivity = when (number) {
                12 -> Kikisday12Activity::class.java
                else -> Kikisday13Activity::class.java
            }
