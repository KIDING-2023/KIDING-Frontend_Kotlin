...
import com.example.kiding.databinding.ActivityKikisdayPurpleCompleteBinding

class KikisdayPurpleCompleteActivity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdayPurpleCompleteBinding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdayPurpleCompleteBinding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            ...
            val previousActivity = when (number) {
                ...
                else -> Kikisday18Activity::class.java
            }
