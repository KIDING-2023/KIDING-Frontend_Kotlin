...
import com.example.kiding.databinding.ActivityKikisdaySkyblueCompleteBinding

class KikisdaySkyblueCompleteActivity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdaySkyblueCompleteBinding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdaySkyblueCompleteBinding.inflate(layoutInflater)
        ...
        Handler().postDelayed({
            val nextActivity = when (number) {
                10 -> KikisdayRandomDice3Activity::class.java
                else -> KikisdayRandomDice2Activity::class.java
            }
