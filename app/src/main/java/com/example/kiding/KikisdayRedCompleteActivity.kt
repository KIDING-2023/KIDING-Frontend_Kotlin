...
import com.example.kiding.databinding.ActivityKikisdayRedCompleteBinding

class KikisdayRedCompleteActivity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdayRedCompleteBinding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdayRedCompleteBinding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            chronometer.stop()
            intent = Intent(this, Kikisday9Activity::class.java)
