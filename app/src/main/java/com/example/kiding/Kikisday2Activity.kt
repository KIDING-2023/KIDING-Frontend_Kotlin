...
import com.example.kiding.databinding.ActivityKikisday2Binding

class Kikisday2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisday2Binding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisday2Binding.inflate(layoutInflater)
        ...
        val dice = 2 - intent.getIntExtra("dice", 0)
        ...
        binding.btn.setOnClickListener {
            chronometer.stop()
            intent = Intent(this, KikisdayGreenCompleteActivity::class.java)
            intent.putExtra("elapsedTime", SystemClock.elapsedRealtime() - chronometer.base)
