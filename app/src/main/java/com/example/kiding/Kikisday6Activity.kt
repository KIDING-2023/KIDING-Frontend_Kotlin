...
import com.example.kiding.databinding.ActivityKikisday6Binding

class Kikisday6Activity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisday6Binding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisday6Binding.inflate(layoutInflater)
        ...
        val dice = 6 - intent.getIntExtra("dice", 0)
        ...
        binding.btn.setOnClickListener {
            chronometer.stop()
            intent = Intent(this, KikisdayOrangeCompleteActivity::class.java)
            intent.putExtra("elapsedTime", SystemClock.elapsedRealtime() - chronometer.base)
