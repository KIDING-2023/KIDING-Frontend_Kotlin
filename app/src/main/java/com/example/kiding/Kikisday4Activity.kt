...
import com.example.kiding.databinding.ActivityKikisday4Binding

class Kikisday4Activity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisday4Binding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisday4Binding.inflate(layoutInflater)
        ...
        val dice = 4 - intent.getIntExtra("dice", 0)
