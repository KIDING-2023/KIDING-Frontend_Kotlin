...
class KikisdayRedComplete2Activity : AppCompatActivity() {

    private lateinit var binding: ActivityKikisdayRedComplete2Binding

    private lateinit var chronometer: Chronometer

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityKikisdayRedComplete2Binding.inflate(layoutInflater)
        ...
        binding.backBtn.setOnClickListener {
            chronometer.stop()
            intent = Intent(this, Kikisday15Activity::class.java)
